...
void documentation () {
	printf("\nDocumentation:\n");
	printf("\tInput Username: USER <username> eg: USER tungbt\n");
	printf("\tInput Password: PASS <password> eg: PASS 12345\n");
	printf("\tLogout By Username: LOGOUT <username> eg: LOGOUT tungbt\n");
	printf("---------------------------------------------------------\n");
}
